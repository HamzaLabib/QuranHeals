...
/**
 * The official multicolour Google "G" logomark, bundled locally as inline
 * SVG paths (react-native-svg is already a dependency, used transitively by
 * lucide-react-native's icon renderer) — never loaded from a remote URL and
 * never approximated with a plain "G" glyph, emoji, or unrelated icon.
 * Deliberately not mirrored for RTL — a brand mark keeps its fixed
 * orientation regardless of interface direction.
 */
