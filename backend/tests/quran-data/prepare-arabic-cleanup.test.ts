...
// The backup/report path-destination assertions previously lived here. They
// now live in backend/tests/quran-data/backup-paths.test.ts, alongside the
// equivalent fullQuran assertion, importing only the side-effect-free
// backend/src/utils/backupPaths.ts rather than either script module.
